  ...
  return (
    <div className="min-h-screen bg-neutral-950 relative text-white">
      ...
      {currentView === "all-movies" ? (
            ...
            <>
              ...
              <div className="flex justify-center items-center gap-6 mt-16">
                ...
                <div className="text-lg font-medium">
                  Page <span className="text-yellow-500">{currentPage + 1}</span> of {totalPages}
                </div>
        ...
        <Profile onNavigate={(view) => { setCurrentView(view); setSearchQuery(""); }} onMovieClick={setSelectedMovie} />
      ) : currentView === "see-all" ? (
        <div className="container mx-auto px-4 py-12">
        ...
        <>
          ...
          <main className="container mx-auto px-4 py-12">
            {loading ? (
              <div className="text-center text-gray-500">Loading movies from database...</div>
            ) : (
              <>
                {/* Jeśli szukamy, zmień tytuł sekcji */}
                <MovieSection
                  title={searchQuery ? `Search results: "${searchQuery}"` : "Popular now"}
                  movies={movies.slice(0, 10)}
                  onMovieClick={setSelectedMovie}
                  onSeeAll={() => openSeeAll("Popular now")}
                />
