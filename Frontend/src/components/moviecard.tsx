...
export function MovieCard({ title, year, rating, runtime, genre, imageUrl, onClick }: MovieCardProps) {
  return (
    <Card
      onClick={onClick}
      className="group overflow-hidden border-0 bg-transparent transition-transform hover:scale-105 cursor-pointer" // Dodano cursor-pointer
    >
      <CardContent className="p-0">
        ...
        <div className="mt-3 px-1">
          <h3 className="line-clamp-1 text-sm text-gray-900">{title}</h3>
